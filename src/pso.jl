...
function run_pso(landscape; swarm_size::Int=50, iterations::Int=500 
    ...
    for iter in 1:iterations
        ...
        for i in 1:swarm_size
            ...
            # Velocity update. Two random vectors — this is what makes PSO stochastic. Without randomness every particle would move identically.
